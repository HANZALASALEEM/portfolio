        ...
        <div className="w-[90%] mx-auto lg:w-1/2 lg:px-[3%]">
          ...
          <div className="my-5">
            <p className="text-white text-lg text-center">
              ...
              My expertise includes building scalable web and mobile
              applications for both{" "}
              <strong className="text-primary">Android and iOS</strong>, with a
              solid command of technologies like Firebase, React Navigation, and
              advanced animations. I also have experience in designing
              user-centric interfaces using tools such as Wondershare Mockitt,
              ensuring a balance between performance and visual appeal.
            </p>
          </div>
        </div>
      </div>
