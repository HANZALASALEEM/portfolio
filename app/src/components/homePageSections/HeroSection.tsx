        ...
        <div className="w-[90%] flex flex-col lg:flex-row justify-center items-center">
          ...
          <div className="lg:w-1/2 w-[95%] flex flex-col p-2 mt-10 lg:p-5">
            ...
            <div className="my-5 flex flex-col sm:flex-row items-center justify-center sm:justify-evenly">
              <button className="w-[150px] h-10 border-[2px] border-primary rounded-full text-primary my-2 hover:bg-primary hover:text-white">
                Hire Me
              </button>
              <button className="w-[150px] h-10 border-[2px] border-primary rounded-full text-primary my-2 hover:bg-primary hover:text-white">
                Download CV
          ...
          {/* Left div */}
          <div className="lg:w-1/2 w-[70%] flex items-center justify-between">
            {/* Left div */}
